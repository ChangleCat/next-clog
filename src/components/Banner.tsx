  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center text-text-main-dark">
        ...
        <Typewriter sentences={Sentences} className="text-lg md:text-xl" />
      </div>
      {/* 跳动的箭头 */}
      <a
        className="absolute bottom-2 left-1/2 -translate-x-1/2 text-5xl animate-bounce-pulse text-text-main-dark cursor-pointer"
        title="向下滚动"
        href={`#${scrollID}`}
        id="scroll-end"
      >
